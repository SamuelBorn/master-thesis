...
\begin{figure}[tbhp]
	...
	\end{subfigure}
    \caption{Illustration of parameter interplay on separator size scaling in hierarchical Delaunay graphs. Graphs (b),(c) and (d) have a decreased \(f_2\) compared to the baseline (a). Paramter changes to fix the scaling are highlighted green.}
