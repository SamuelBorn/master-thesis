...
This observation, stemming from experimental results of the Customizable Contraction Hierarchies (CCH) paper \cite{dibbelt_customizable_2016}, serves as a key inspiration for this thesis.
...
The following provides an overview of the CCH algorithm, with a focus on how its components benefit from the small separators found in road networks.
